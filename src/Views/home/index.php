            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text"><?= t('home.login.description') ?></p>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title"><?= t('home.howItWorks.step1.title') ?></h5>
                            <p class="card-text"><?= t('home.howItWorks.step1.description') ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title"><?= t('home.howItWorks.step2.title') ?></h5>
                            <p class="card-text"><?= t('home.howItWorks.step2.description') ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title"><?= t('home.howItWorks.step3.title') ?></h5>
                            <p class="card-text"><?= t('home.howItWorks.step3.description') ?></p>
                        </div>
                    </div>
                </div>
            </div>
