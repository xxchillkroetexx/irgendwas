...
class GroupRepository extends DataMapper {
    ...
    protected array $columns = [
        'id', 'name', 'description', 'admin_id', 'invitation_code', 'registration_deadline',
        'draw_date', 'is_drawn', 'created_at', 'updated_at'
    ];
    ...
    private function drawSecretSanta(array $members, array $exclusionMap): array {
        $givers = array_map(function($user) { return $user->getId(); }, $members);
        $receivers = $givers;
        $assignments = [];
